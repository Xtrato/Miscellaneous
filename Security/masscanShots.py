#This program takes a masscan XML file and iterates through it taking screenshots of the webpages. You can also input
# files generated by Nmap. It uses the wkhtmltopdf software to do this.
#README at https://github.com/Xtrato/Miscellaneous/blob/master/Readme%27s/masscanShots.md
